...
export default function Nav() {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full flex items-center justify-between flex-wrap px-6 py-3 border-b-2">
            ...
            <div className="text-sm lg:flex-grow">
                ...
                <a href="/login" className="block mt-4 lg:inline-block lg:mt-0 text-white-200 mr-4 font-bold">
                LOGIN 
                </a>
                <a href="/register" className="block mt-4 lg:inline-block lg:mt-0 text-white-200 mr-4 font-bold">
                REGISTER
                </a>
